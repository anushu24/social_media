<?php
   ...
   session_start();
   $id=$_SESSION['id'];
   $query=mysqli_query($conn,"SELECT * FROM user_login where user_id='$id'")or die(mysqli_error());
 ...
 if(isset($_POST['loginsubmit']))
    {
      ...
      $bio = $_POST['bio'];
      $phone = $_POST['phone'];
      $sql= $query = "UPDATE user_login SET name='$fullname', user_name = '$username', bio = '$bio', phone = '$phone' WHERE user_id = '$id'";
