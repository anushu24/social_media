...
<head>
   ...
   $content = $_POST['posted'];
   //post is the name of table created
   if(strlen($content)>150 || strlen($content)<1){
       ?>
       <script>alert("Incorrect length")</script>
       <?php
   }
   else{

   $sql= "insert into post (user_id, user_email,user_name, caption,post_date) values('$session_id','$session_email','$session_username','$content',NOW());
                ...
                <div class="row">
                    <div class="col-8">
                        ...
                        <div class="main mainpost" style="margin-bottom:20px; padding-bottom:10px; width: 700px; margin-left: -70px;">    
                            ...
                            <p class="quotes">
                                <textarea id="mypara" placeholder="Share an article ,photo ,video or idea." name = "posted" ></textarea>
                            </p>
                            <!-- image load to post -->
                            <div class="post">
                            ...
                            <div class="postbar">
                                ...
                                <button type="button" id="postmypost" class="postmypost" onclick="mypost();" name= "submit">Post</button>
                            </div>
